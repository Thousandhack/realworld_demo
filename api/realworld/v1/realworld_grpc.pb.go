...
type RealWorldClient interface {
	...
	GetCurrentUser(ctx context.Context, in *GetCurrentRequest, opts ...grpc.CallOption) (*UserReply, error)
	...
	FeedListArticles(ctx context.Context, in *FeedArticlesRequest, opts ...grpc.CallOption) (*ListArticlesReply, error)
	...
	UpdateArticle(ctx context.Context, in *CreateArticleRequest, opts ...grpc.CallOption) (*SingleArticleReply, error)
	...
	GetComment(ctx context.Context, in *GetCommentRequest, opts ...grpc.CallOption) (*SingleCommentReply, error)
	...
	GetTags(ctx context.Context, in *GetTagsRequest, opts ...grpc.CallOption) (*TagsListReply, error)
}
...
func (c *realWorldClient) GetCurrentUser(ctx context.Context, in *GetCurrentRequest, opts ...grpc.CallOption) (*UserReply, error) {
	out := new(UserReply)
...
func (c *realWorldClient) FeedListArticles(ctx context.Context, in *FeedArticlesRequest, opts ...grpc.CallOption) (*ListArticlesReply, error) {
	out := new(ListArticlesReply)
	err := c.cc.Invoke(ctx, "/realworld.v1.RealWorld/FeedListArticles", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *realWorldClient) UpdateArticle(ctx context.Context, in *CreateArticleRequest, opts ...grpc.CallOption) (*SingleArticleReply, error) {
	out := new(SingleArticleReply)
...
func (c *realWorldClient) GetComment(ctx context.Context, in *GetCommentRequest, opts ...grpc.CallOption) (*SingleCommentReply, error) {
	out := new(SingleCommentReply)
...
func (c *realWorldClient) GetTags(ctx context.Context, in *GetTagsRequest, opts ...grpc.CallOption) (*TagsListReply, error) {
...
type RealWorldServer interface {
	...
	FeedListArticles(context.Context, *FeedArticlesRequest) (*ListArticlesReply, error)
	...
	UpdateArticle(context.Context, *CreateArticleRequest) (*SingleArticleReply, error)
	...
	GetTags(context.Context, *GetTagsRequest) (*TagsListReply, error)
...
func (UnimplementedRealWorldServer) GetCurrentUser(context.Context, *GetCurrentRequest) (*UserReply, error) {
...
func (UnimplementedRealWorldServer) FeedListArticles(context.Context, *FeedArticlesRequest) (*ListArticlesReply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method FeedListArticles not implemented")
}
...
func (UnimplementedRealWorldServer) UpdateArticle(context.Context, *CreateArticleRequest) (*SingleArticleReply, error) {
...
func (UnimplementedRealWorldServer) GetComment(context.Context, *GetCommentRequest) (*SingleCommentReply, error) {
...
func (UnimplementedRealWorldServer) GetTags(context.Context, *GetTagsRequest) (*TagsListReply, error) {
...
func _RealWorld_GetCurrentUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RealWorldServer).GetCurrentUser(ctx, req.(*GetCurrentRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _RealWorld_FeedListArticles_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(FeedArticlesRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RealWorldServer).FeedListArticles(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/realworld.v1.RealWorld/FeedListArticles",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RealWorldServer).FeedListArticles(ctx, req.(*FeedArticlesRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _RealWorld_UpdateArticle_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RealWorldServer).UpdateArticle(ctx, req.(*CreateArticleRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var RealWorld_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "FeedListArticles",
			Handler:    _RealWorld_FeedListArticles_Handler,
		},
		{
