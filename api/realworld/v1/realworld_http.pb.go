...
func _RealWorld_UpdateArticle0_HTTP_Handler(srv RealWorldHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		...
		h := ctx.Middleware(func(ctx context.Context, req interface{}) (interface{}, error) {
			return srv.UpdateArticle(ctx, req.(*CreateArticleRequest))
		})
		out, err := h(ctx, &in)
		if err != nil {
			return err
...
type RealWorldHTTPClient interface {
	...
	FeedListArticles(ctx context.Context, req *FeedArticlesRequest, opts ...http.CallOption) (rsp *ListArticlesReply, err error)
	...
	GetTags(ctx context.Context, req *GetTagsRequest, opts ...http.CallOption) (rsp *TagsListReply, err error)
	...
	UpdateArticle(ctx context.Context, req *CreateArticleRequest, opts ...http.CallOption) (rsp *SingleArticleReply, err error)
...
func (c *RealWorldHTTPClientImpl) FeedListArticles(ctx context.Context, in *FeedArticlesRequest, opts ...http.CallOption) (*ListArticlesReply, error) {
...
func (c *RealWorldHTTPClientImpl) GetTags(ctx context.Context, in *GetTagsRequest, opts ...http.CallOption) (*TagsListReply, error) {
...
func (c *RealWorldHTTPClientImpl) UpdateArticle(ctx context.Context, in *CreateArticleRequest, opts ...http.CallOption) (*SingleArticleReply, error) {
	var out SingleArticleReply
	pattern := "/api/article/{slug}"
	path := binding.EncodeURL(pattern, in, false)
